...
exports.default = function (webpackConfig) {
  var webpackDevMiddlewareConfig = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
  ...
  var devMiddlewareConfig = _config2.default.devMiddleware(webpackDevMiddlewareConfig);
